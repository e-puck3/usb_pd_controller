...
1) Add these lines somewhere in the makefile in the same manner you need to do with components of ChibiOS. The path should link to the pdblib folder and is referenced from your makefile
